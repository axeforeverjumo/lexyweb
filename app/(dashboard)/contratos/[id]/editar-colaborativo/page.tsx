...
import CollaborativeEditorWrapper from '@/components/collaborative-editor/CollaborativeEditorWrapper';

interface PageProps {
  params: Promise<{ id: string }>;
}

export default async function CollaborativeEditPage({ params }: PageProps) {
